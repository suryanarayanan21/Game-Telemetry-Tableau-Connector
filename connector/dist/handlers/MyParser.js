...
})({"6w7cJ":[function(require,module,exports) {
...
class MyParser extends Parser {
    parse(fetcherResult, { dataContainer }) {
        ...
        let data = Object.keys(fetcherResult).map((key)=>fetcherResult[key]);
        tableBuilder.addRows(data.map((row)=>{
            return {
                ...row
            };
        }));
